...
export const Base = (args: MainProps) => (
  <Main {...args}>
    <p>
    ...
    <p>
      Ursa minor roar ursa minor panda honey honey growl koala coat. Roar koala
      bear, ursa major brown honey coat ursa minor brown brown koala honey
      grizzly ursa minor. Cub growl cub growl ursus brown ursus bear ursus.
    </p>
  </Main>
);
